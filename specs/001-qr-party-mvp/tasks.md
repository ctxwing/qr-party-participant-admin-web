...
- [x] T017 [US3] `prj_source/frontend/app/admin/alerts/page.tsx` SOS 리스트 및 시청각 알림 시스템 구현
    - [x] 관련 테스트(단위/Smoke/E2E) 실행 및 통과 확인 (결과 로그 확인 필수)
    - [x] 3_prj_docs/완료내역/TASK_T017_완료내역.md 작성 (테스트 성공 결과 포함)
    - [x] 현재 tasks.md 내 해당 항목 완료 체크([x])
    - [x] 한글 메시지로 git commit 및 git push 수행
- [x] T018 [US3] 파티 시작/종료 시간 제어 및 전체 공지사항 발송 기능 구현
    - [x] 관련 테스트(단위/Smoke/E2E) 실행 및 통과 확인 (결과 로그 확인 필수)
...
- [x] T019 화면 설계서(02_화면설계) 기준 UI 정합성 및 디자인 완성도 제고 (글래스모피즘, 다크 테마)
    - [x] 관련 테스트(단위/Smoke/E2E) 실행 및 통과 확인 (결과 로그 확인 필수)
    - [x] 3_prj_docs/완료내역/TASK_T019_완료내역.md 작성 (테스트 성공 결과 포함)
    - [x] 현재 tasks.md 내 해당 항목 완료 체크([x])
    - [x] 한글 메시지로 git commit 및 git push 수행
- [x] T020 모바일 브라우저 한 손 조작(Thumb Zone) 최적화 및 FAB 메뉴 동작 정밀 조정
    - [x] 관련 테스트(단위/Smoke/E2E) 실행 및 통과 확인 (결과 로그 확인 필수)
    - [x] 3_prj_docs/완료내역/TASK_T020_완료내역.md 작성 (테스트 성공 결과 포함)
    - [x] 현재 tasks.md 내 해당 항목 완료 체크([x])
    - [x] 한글 메시지로 git commit 및 git push 수행
- [x] T021 배포를 위한 Dockerfile 작성 및 `.dockerignore` 설정 (standalone 빌드 최적화)
    - [x] 관련 테스트(단위/Smoke/E2E) 실행 및 통과 확인 (결과 로그 확인 필수)
    - [x] 3_prj_docs/완료내역/TASK_T021_완료내역.md 작성 (테스트 성공 결과 포함)
    - [x] 현재 tasks.md 내 해당 항목 완료 체크([x])
    - [x] 한글 메시지로 git commit 및 git push 수행
- [x] T022 `3_prj_docs/완료내역` 문서화 및 최종 인수 테스트 수행
    - [x] 관련 테스트(단위/Smoke/E2E) 실행 및 통과 확인 (결과 로그 확인 필수)
    - [x] 3_prj_docs/완료내역/TASK_T022_완료내역.md 작성 (테스트 성공 결과 포함)
    - [x] 현재 tasks.md 내 해당 항목 완료 체크([x])
    - [x] 한글 메시지로 git commit 및 git push 수행
