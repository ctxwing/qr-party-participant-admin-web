...
- [ ] T002 [STEP 1.1] ag-grid v35, qrcode.react, Supabase Realtime 기술 조사
    ...
    - [ ] 현재 tasks.md 내 해당 항목 완료 체크([x])
    - [ ] 한글 메시지로 git commit 및 git push 수행
- [ ] T003 [P] [STEP 1.2] qrcode.react 및 Canvas API를 활용한 로고 병합 기술 검증
    - [ ] 관련 테스트(단위/Smoke/E2E) 실행 및 통과 확인 (결과 로그 확인 필수)
    - [ ] 3_prj_docs/완료내역/TASK_T003_완료내역.md 작성 (테스트 성공 결과 포함)
    - [ ] 현재 tasks.md 내 해당 항목 완료 체크([x])
    - [ ] 한글 메시지로 git commit 및 git push 수행
- [ ] T004 [P] [STEP 1.2] Supabase Realtime을 통한 실시간 공지 수신 기술 검증
    - [ ] 관련 테스트(단위/Smoke/E2E) 실행 및 통과 확인 (결과 로그 확인 필수)
    - [ ] 3_prj_docs/완료내역/TASK_T004_완료내역.md 작성 (테스트 성공 결과 포함)
    - [ ] 현재 tasks.md 내 해당 항목 완료 체크([x])
    - [ ] 한글 메시지로 git commit 및 git push 수행
...
- [ ] T010 [US1] 관리자 로그인 페이지 UI 및 인증 연동 구현
    ...
    - [ ] 현재 tasks.md 내 해당 항목 완료 체크([x])
    - [ ] 한글 메시지로 git commit 및 git push 수행
- [ ] T011 [US1] ag-grid v35 공통 설정 파일 작성 (`prj_source/frontend/src/lib/ag-grid-setup.ts`)
    - [ ] 관련 테스트(단위/Smoke/E2E) 실행 및 통과 확인 (결과 로그 확인 필수)
